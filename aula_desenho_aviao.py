...
def desenho():    
    ...
    glBegin(GL_POLYGON)# Asa maior
    glColor3f(.1, .6, .1) # cor RGB
    glVertex3f( 0.0, 6.0, 0.0  )  #  ponto de vertice
    glVertex3f( 7.0, 6.0, 0.0  )  #  ponto de vertice
    glVertex3f( 7.0, 4.0, 0.0  )  #  ponto de vertice
    glVertex3f( 0.0, 4.0, 0.0  )  #  ponto de vertice
    glEnd()

    glBegin(GL_POLYGON)# Asa menor
    glColor3f(.1, .6, .1) # cor RGB
    glVertex3f( 2.0, 2.0, 0.0  )  #  ponto de vertice
    glVertex3f( 5.0, 2.0, 0.0  )  #  ponto de vertice
    glVertex3f( 5.0, 1.0, 0.0  )  #  ponto de vertice
    glVertex3f( 2.0, 1.0, 0.0  )  #  ponto de vertice
    glEnd()
  
    glBegin(GL_POLYGON)# Meio do aviao
    glColor3f(.3, .4, .1) # cor RGB
    glVertex3f( 3.0, 7.0, 0.0  )  #  ponto de vertice
    glVertex3f( 4.0, 7.0, 0.0  )  #  ponto de vertice
    glVertex3f( 4.0, 0.0, 0.0  )  #  ponto de vertice
    glVertex3f( 3.0, 0.0, 0.0  )  #  ponto de vertice
    glEnd()

    glBegin(GL_POLYGON)# helice
    glColor3f(.3, .4, .5) # cor RGB
    glVertex3f( 2.5, 7.0, 0.0  )  #  ponto de vertice
    glVertex3f( 2.5, 7.3, 0.0  )  #  ponto de vertice
    glVertex3f( 4.5, 7.3, 0.0  )  #  ponto de vertice
    glVertex3f( 4.5, 7.0, 0.0  )  #  ponto de vertice
    glEnd()

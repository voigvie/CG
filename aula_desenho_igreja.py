...
def desenho():    
    ...
    #glRotatef(30, 0.0, 0.0, 1.0)     #Rotaçao do objeto
    glScale(0.1, 0.1, 0.1)
    ...
    glVertex3f( 5.0, 4.0, 0.0  )  #  ponto de vertice
    glVertex3f( 4.5, 5.0, 0.0  )  #  ponto de vertice
    glVertex3f( 4.0, 4.0, 0.0  )  #  ponto de vertice
    ...
    glVertex3f( 4.0, 0.0, 0.0  )  #  ponto de vertice
    glVertex3f( 4.0, 3.0, 0.0  )  #  ponto de vertice
    glVertex3f( 2.5, 4.0, 0.0  )  #  ponto de vertice
    glVertex3f( 1.0, 3.0, 0.0  )  #  ponto de vertice
    glVertex3f( 1.0, 4.0, 0.0  )  #  ponto de vertice
    glVertex3f( 0.5, 5.0, 0.0  )  #  ponto de vertice
